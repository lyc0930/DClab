...
HD_PWD='/home/lyc/文档/数字电路实验工程/Vivado数字电路实验/lab11/FinalWorkVGA/FinalWorkVGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_Output.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_Output.tcl
