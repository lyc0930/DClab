...
#
# Generated by Vivado on Thu Dec 20 18:56:30 +0800 2018
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../FinalWorkVGA.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../FinalWorkVGA.srcs/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../FinalWorkVGA.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
