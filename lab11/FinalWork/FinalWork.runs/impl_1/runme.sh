...
HD_PWD='C:/Users/EnglishOnly/Desktop/Vivado/lab11/FinalWork/FinalWork.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PCB16_16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PCB16_16.tcl -notrace
