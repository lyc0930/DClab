...
#
# Generated by Vivado on Fri Dec 14 14:44:26 +0800 2018
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../FinalWork.srcs/sources_1/ip/clk_wiz_1" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../FinalWork.srcs/sources_1/ip/clk_wiz_1" \
    "$ref_dir/../../../../FinalWork.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
