...
HD_PWD='C:/Users/EnglishOnly/Desktop/Vivado/lab6/lab6_1_3/lab6_1_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_one_bit_serial_shift_register_behavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple_one_bit_serial_shift_register_behavior.tcl -notrace
