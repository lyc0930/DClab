...
HD_PWD='C:/Users/EnglishOnly/Desktop/Vivado/lab6/lab6_1_3/lab6_1_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_one_bit_serial_shift_register_behavior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_one_bit_serial_shift_register_behavior.tcl
