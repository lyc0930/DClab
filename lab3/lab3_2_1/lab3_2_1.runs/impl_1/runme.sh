...
HD_PWD='C:/Users/EnglishOnly/Desktop/Vivado/lab3/lab3_2_1/lab3_2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_8to3_behavioral.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder_8to3_behavioral.tcl -notrace
